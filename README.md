...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-daq-jg8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-daq-jg8.containers.anotherwebservice.com/
...
```
git clone git@github.com:arjunlubana/container-daq-jg8.git
cd container-daq-jg8
```
...
```
docker attach container-daq-jg8
```
